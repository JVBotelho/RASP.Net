...
public class InterceptorBenchmarks
{
    ...
    public void Setup()
    {
        ...
        _realInterceptor = new SecurityInterceptor(compositeEngine, inspector, options, metrics, bus, interceptorLogger);
        _baselineInterceptor = new SecurityInterceptor(noOpEngine, inspector, options, metrics, bus, interceptorLogger);
